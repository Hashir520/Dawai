	...
	<div class="container-fluid">
		...
		echo'
			<div class="col-75">
					...
					<div class="col-50">
						...
						<div class="col-50">
							<div class="form-group CVV">
								<label for="cvv">Cash on Delivery</label>
						</div>
						</div>
					</div>
					</div>
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					<input type="hidden" name="total_price" value="Pkr '.$total.'">
		...
		?>
			<div class="col-25">
				...
				echo"</tbody></table><hr>
				<h3>total<span class='price' style='color:black'><b>Pkr $total</b></span></h3>";
				}
				?>
				</div>
			</div>
