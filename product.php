				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Pkr '.$row['product_price'].'</h3>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															...
															<p class="date">27 March 2024, 8:0 PM</p>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Hashir</h5>
															<p class="date">22 March 2024, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Haider</h5>
															<p class="date">19 March 2024, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
										...
										<div class="col-md-3 mainn">
											<div id="review-form">
												<form class="review-form">
													...
													<button href="#" class="primary-btn">Submit</button>
												</form>
											</div>
										</div>
										<!-- /Review Form -->
